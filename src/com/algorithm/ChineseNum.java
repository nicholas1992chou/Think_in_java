...
public class ChineseNum {
    ...
    public static double cnNumConvert(String expression){
    	if(expression.contains("点")){
    		return cnNumericToArabic(expression.substring(0,expression.lastIndexOf('点')), true)
    				+qCNNumericToArabic(expression.substring(expression.lastIndexOf('点')+1));
    	}
    	return cnNumericToArabic(expression,true);
    }
   public static void main(String[] args) {
       //System.out.println(cnNumericToArabic("一四零五六七八", true));
	   System.out.println(cnNumConvert("七千八百亿"));
    }
